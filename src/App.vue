...
export default {
  ...
  methods:{
    outputGoals(){
      return (((Math.random()*10)+1)>5)?this.courseGoalA:this.courseGoalB;
    },
    IncreaseMethod(){
  ...
  computed:{
    FullName(){
      ...
      return `${this.name} Connor`;
    },
    FirstChoice(){
      return {Box:this.Firstchosen}
    }
  },
}
</script>
...
#user-goals{
  ...
  box-shadow: -3px 3px #159b42, -1px 1px #159b42, -3px 3px #159b42 ;
